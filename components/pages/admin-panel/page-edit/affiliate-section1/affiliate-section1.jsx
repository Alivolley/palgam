...
// Assets
import affiliateSection1Pic from '@/assets/images/adminPanel/affiliate-section1Pic.png';
...
function AffiliateSection1() {
   ...
   useEffect(() => {
      if (pagesData) {
         setValue('labelEn', pagesData?.affiliate_page?.english_data?.section1?.label);
         setValue('labelEs', pagesData?.affiliate_page?.spanish_data?.section1?.label);
         setValue('labelRu', pagesData?.affiliate_page?.russian_data?.section1?.label);
         setValue('titleEn', pagesData?.affiliate_page?.english_data?.section1?.title);
         setValue('titleEs', pagesData?.affiliate_page?.spanish_data?.section1?.title);
         setValue('titleRu', pagesData?.affiliate_page?.russian_data?.section1?.title);
         setValue('descriptionEn', pagesData?.affiliate_page?.english_data?.section1?.description);
         setValue('descriptionEs', pagesData?.affiliate_page?.spanish_data?.section1?.description);
         setValue('descriptionRu', pagesData?.affiliate_page?.russian_data?.section1?.description);
      }
   }, [pagesData]);
