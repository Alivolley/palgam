...
// Assets
import homeSection4Pic from '@/assets/images/adminPanel/home-section4.png';
...
function HomeSection4() {
   ...
   useEffect(() => {
      if (pagesData) {
         setValue('titleEn', pagesData?.home_page?.english_data?.section4?.title);
         setValue('titleEs', pagesData?.home_page?.spanish_data?.section4?.title);
         setValue('titleRu', pagesData?.home_page?.russian_data?.section4?.title);
         setValue('descriptionEn', pagesData?.home_page?.english_data?.section4?.description);
         setValue('descriptionEs', pagesData?.home_page?.spanish_data?.section4?.description);
         setValue('descriptionRu', pagesData?.home_page?.russian_data?.section4?.description);
      }
   }, [pagesData]);
   ...
   return (
      <div className="mt-6">
         <div className="w-full">
            <Image src={homeSection4Pic} alt="sample" className="size-full rounded-2xl object-cover" />
         </div>
         <div className="my-6">
