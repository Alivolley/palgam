...
// Assets
import supportTermsPic from '@/assets/images/adminPanel/support-termsPic.png';
...
function SupportTerms() {
   ...
   useEffect(() => {
      if (pagesData) {
         setValue('descriptionEn', pagesData?.suppurt_pages?.english_data?.terms?.description);
         setValue('descriptionEs', pagesData?.suppurt_pages?.spanish_data?.terms?.description);
         setValue('descriptionRu', pagesData?.suppurt_pages?.russian_data?.terms?.description);
      }
   }, [pagesData]);
   ...
   return (
      <div className="mt-6">
         <div className="w-full">
            <Image src={supportTermsPic} alt="sample" className="size-full rounded-2xl object-cover" />
         </div>
         <div className="my-6">
